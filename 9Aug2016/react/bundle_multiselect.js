...
Version : 0.1
Status : Development
Description : This file has been built using nodejs for the purpose of creating typeahead using ReactJS.
		      This file can be used as standalone javascript for the same.
*/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TokenInput = __webpack_require__(159);
	var ComboboxOption = __webpack_require__(159).Option;
	
	var without = __webpack_require__(166);
	...
	var App = React.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    return {
	      input: '',
	      loading: false,
	      selected: this.props.initialSkills,
	      options: this.props.options,
	      source_url: this.props.source,
	      newNames : [],
	      makeStatic : false,
	    };
	  },
	  ...
	  handleSelect: function handleSelect(value, combobox) {
	  ...
	  handleInput: function handleInput(userInput) {
	    this.setState({
	      input: userInput,
	      loading: true,
	      options: []
	  ...
	  filterTags: function filterTags(userInput) {
	  	//alert(userInput);
	  	var urlToHit = this.state.source_url + userInput;
	  	$.get(urlToHit, function (result) {
	  		  //alert(result);
		      //need to write logic for the API. 
		      var skillSuggestions = [];
		      var maxSkillsSuggestions = 0;
				for (var key in result) {
					//console.log(result[key]);
					if (maxSkillsSuggestions > 10){
						break;
					}
					if (result.hasOwnProperty(key) && maxSkillsSuggestions <= 10) {
						skillSuggestions.push(result[key].Name);
					}
					maxSkillsSuggestions++;
				}
				this.state.newNames = skillSuggestions.map(function (name) {
					return {
						id: name,
						name: name
					};
	    ...
	    var filteredNames = this.state.newNames.filter(function (state) {
	      return filter.test(state.name); // || filter.test(state.id);
	    }).filter(function (state) {
	      return this.state.selected.map(function (value) {
	        return value.name;
	  ...
	  renderComboboxOptions: function renderComboboxOptions() {
	  ...
	  handleSave : function(event){
	    ...
	    console.log(skillNames.join());
	  	var urlToHit = "http://my.monsterindia.noida/edit-skills.html";
	  	jQuery.ajax({
			      url: urlToHit,
			      type: 'POST',
			      dataType: 'json',
			      ...
			      success: function(data){
			        ...
			        {
			        	alert(data.MSG);
			        	this.props.parentEditHandler(false);
			        	this.setState({makeStatic : true});
			        }	      			
			      }.bind(this),
	  ...
	  render: function render() {
	    ...
	    var loadingComponent = React.createElement('img', { src: 'spinner.gif' });
		
		if(this.state.makeStatic)
		{
			//Populate the static (uneditable) skills and endorsements block
			
			var finalStaticSkills =  this.state.selected.map(function (value) {
					        		return React.createElement('div',
			      												null,
					        								div({
											        		 className : "skill_pill"
											        		},
											        		React.createElement('span', {}), value.name)
											        		);
		      								});
			return React.createElement(
			      'div',
		...
		else
		{
		    return React.createElement(
		      ...
		      div({
		      		...
		      		a({
		      			href : "#skills", 
		      			className : "btn cancel_btn pf_hideaction",
...
//React code related to Domain Typeahead
var EndorsedSkillsBox = React.createClass({
	  displayName: 'EndorsedSkillsBox',
	  ...
	  handleEditFromChild: function(editFlagFromChild){
	  	console.log('inside handleEditFromChild');
	  	this.setState({editFlag : editFlagFromChild});
	  },
	  handleSave : function(event){
	  	event.preventDefault();
	  	var skillNames = [];
	  ...
	  render: function render() {
	  	console.log('flag== ' + this.state.editFlag);
	  	var div = React.createFactory('div');
		var a = React.createFactory('a');
		var input = React.createFactory('input');

		var initialData = [];
		//Skills if the API fails in any case
	    var data = {
	    ...
	    for (var key in data) {
	      if (data.hasOwnProperty(key)) {
	        initialData.push(data[key]);
	      }
	    }
	    var names = initialData.map(function (name) {
	      return {
	        id: name,
	        name: name
	      };
		...
		else
		{
			var finalStaticSkills =  this.state.selected.map(function (value) {
	     	...
	     	return	React.createElement('div',null, a({
		    				id : "skills_action",
		    				className : "rbtn_edit pf_editaction",
		    				title : "",
		    				'data-placement' : "left",
		    				'data-toggle' : "tooltip", 
		    				href : "#skills",
...
$( window ).load(function() {
    ...
    var names = states.map(function (name) {
      return {
        id: name,
        name: name
      };
    ...
    var initialSkills = [];
	var initialSkillIds = [];
	//Preparing skills JSON
    for(var key in endorsedSkills_JSON)
	{
		initialSkills.push(endorsedSkills_JSON[key].TEXT);
		initialSkillIds.push(key);
	}

    var initialSkillsNamesJSON = initialSkills.map(function (name) {	    	
      return {
        id: name,
        name: name
      };
    });
    console.log('init skills' + initialSkillIds);
    ReactDOM.render(React.createElement(EndorsedSkillsBox, {endorsedSkills_JSON : endorsedSkills_JSON, 
    									options: names, source : "http://my.monsterindia.noida/skill-suggest.html?type=skills&q=",  
										initialSkills : initialSkillsNamesJSON,
										initialSkillIds : initialSkillIds,
										parentEditHandler : this.handleEditFromChild }), 
    									document.getElementById('endorsed_skills_static_react'));
  //   function clickEndorsedSkillEdit()
  //   {
  //   	var initialSkills = [];
		// //Preparing skills JSON
	 //    for(var key in endorsedSkills_JSON)
  ...
  //   }
	...
	ReactDOM.render(React.createElement(AppDomainTypeAhead, 
						{ options: names, source : "https://api.github.com/users/octocat/gists"  }),
						 document.getElementById('domain_typeahead'));
});



//React code related to Domain Typeahead
var AppDomainTypeAhead = React.createClass({
	  displayName: 'AppDomainTypeAhead',
	  ...
	  filterTags: function filterTags(userInput) {
	  	//alert(userInput);
	  	$.get(this.state.source_url, function (result) {
			  ...
			  var data = {
				...
				this.state.newNames = states.map(function (name) {
					return {
						id: name,
						name: name
					};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TokenInput = __webpack_require__(160);
	TokenInput.Option = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Combobox = React.createFactory(__webpack_require__(161));
	var Token = React.createFactory(__webpack_require__(164));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var guid = 0;
	var k = function k() {};
	var addClass = __webpack_require__(162);
	var ComboboxOption = __webpack_require__(163);
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return li({
	      ...
	      tabIndex: 0
	    }, "X"), span({ className: "ic-token-label" }, this.props.name));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIndexOf = __webpack_require__(168),
	    ...
	    createCache = __webpack_require__(171),
	    largeArraySize = __webpack_require__(177),
	    releaseObject = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var baseIndexOf = __webpack_require__(168),
	    keyPrefix = __webpack_require__(170);
...
/***/ function(module, exports) {
	 ...
	 * Based on Underscore.js 1.5.2 <http://underscorejs.org/LICENSE>
	 * Copyright 2009-2013 Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
	 * Available under MIT license <lttp://lodash.com/license>
	 */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <http://lodash.com/license>
	 */
	var cachePush = __webpack_require__(172),
	    getObject = __webpack_require__(173),
	    releaseObject = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <http://lodash.com/license>
	 */
	var keyPrefix = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <http://lodash.com/license>
	 */
	var objectPool = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var maxPoolSize = __webpack_require__(176),
	    objectPool = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseUniq = __webpack_require__(180),
	    createCallback = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIndexOf = __webpack_require__(168),
	    cacheIndexOf = __webpack_require__(169),
	    createCache = __webpack_require__(171),
	    getArray = __webpack_require__(181),
	    largeArraySize = __webpack_require__(177),
	    releaseArray = __webpack_require__(183),
	    releaseObject = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <http://lodash.com/license>
	 */
	var baseCreateCallback = __webpack_require__(185),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bind = __webpack_require__(186),
	    ...
	    support = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <http://lodash.com/license>
	 */
	var createWrapper = __webpack_require__(187),
	    slice = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <http://lodash.com/license>
	 */
	var objectTypes = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <http://lodash.com/license>
	 */
	var forIn = __webpack_require__(200),
	    getArray = __webpack_require__(181),
	    isFunction = __webpack_require__(196),
	    objectTypes = __webpack_require__(192),
	    releaseArray = __webpack_require__(183);

...
var SelectBox = React.createClass({displayName: 'exports',
  ...
  render: function () {
    return(
      ...
      <SelectBox label="Favorite Color"
            ...
            <option value="Light greenish with a little bit of yellow"></option>
      </SelectBox>
      <h1>Multi Select Example</h1>*/
      <SelectBox label="Favorite Colors"
            className='my-example-select-box'
...
//ReactDOM.render(Example(null), document.getElementById('example2' ));

...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({
	  ...
	  handleInput: function handleInput(userInput) {		  
		...
		$.ajax({
		  url: 'http://my.monsterindia.noida/reactCombo.html?type=search_com&q='+userInput,
		  dataType: 'json',
		  success: function success(data) {
				var states = [];
				for (var key in data) {
				  if (data.hasOwnProperty(key)) {
					  states.push({id:key,name:data[key]});
				...
				ReactDOM.render(React.createElement(App, { options: names }), document.getElementById('application'));
	  ...
	  filterTags: function filterTags(userInput) {
	    ...
	    var filteredNames = this.props.options.filter(function (state) {
	...
	$.ajax({
	  url:'http://my.monsterindia.noida/reactCombo.html?type=search_com&q=aa',
	  dataType: 'json',
	  success: function success(data) {
	    var states = [];
	    for (var key in data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	      ...
	      tabIndex: 0
	    }, "X"), span({ className: "ic-token-label", name: "search_strings" }, this.props.name));
		}else{
			return li({
	      className: "ic-token inline-flex"
	    }, span({
	      ...
	      className: "ic-token-delete-button",
	      tabIndex: 0
	    }, "X"), span({ className: "ic-token-label", name: "search_strings", id: this.props.value.id }, this.props.name));

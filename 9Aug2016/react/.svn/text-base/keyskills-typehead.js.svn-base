...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({
	  ...
	  handleInput: function handleInput(userInput) {		  
		...
		$.ajax({
		  url: 'http://my.monsterindia.noida/reactCombo.html?type=search_skills&q='+userInput,
		  dataType: 'json',
		  success: function success(data) {
				...
				ReactDOM.render(React.createElement(App, { options: names }), document.getElementById('application_skill'));
...
//	url: 'https://gist.githubusercontent.com/mshafrir/2646763/raw/8b0dbb93521f5d6889502305335104218454c2bf/states_hash.json', 
		  url: 'http://my.monsterindia.noida/reactCombo.html?type=search_skills&q=aa',
	  dataType: 'json',
	  success: function success(data) {
	    var states = [];
	    for (var key in data) {
